...
- **New recommended app architecture** — see the new [ESP_ARCHITECTURE.md](ESP_ARCHITECTURE.md) for the Engine · Signal · Presentation pattern this release's `GameWidget` changes are designed around.
