...
class _VirtualJoystickPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      base,
      radius,
      Paint()..color = baseColor.withValues(alpha: 0.12 * safeOpacity),
    );
    canvas.drawCircle(
      base,
      radius,
      Paint()
        ..color = baseColor.withValues(alpha: 0.30 * safeOpacity)
    ...
    canvas.drawCircle(
      clampedThumb,
      radius * 0.38,
      Paint()..color = thumbColor.withValues(alpha: 0.88 * safeOpacity),
    );
  }
