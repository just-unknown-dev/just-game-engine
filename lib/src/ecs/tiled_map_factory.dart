...
typedef ComponentMapper = Component? Function(
  String className,
...
class TiledMapFactory {
  ...
  static List<Entity> _spawnLayer(
    ...
    if (layer is TileLayer) {
      entities.add(
        _spawnTileLayer(world, map, layer, atlasCollection),
      );
    } else if (layer is ObjectGroup) {
      entities.addAll(
        _spawnObjectGroup(world, map, layer, componentMapper),
      );
  ...
  static Entity _spawnTileLayer(
    ...
    entity.addComponent(TileMapLayerComponent(
      tileLayer: tileLayer,
      renderer: renderer,
      map: map,
    ));
